...
void initVAO()
{
	...
	for (int face = 0; face < 6; face++)
	{
		for (int i = 0; i < 3; i++)
		{
			vertices.push_back(Vertex(positions[faces[face * 2 + 0][i]], tex_coords[indices_tex[face * 2 + 0][i]]));
			indices.push_back(idx++);
		}

		for (int i = 0; i < 3; i++)
		{
			vertices.push_back(Vertex(positions[faces[face * 2 + 1][i]], tex_coords[indices_tex[face * 2 + 1][i]]));
			indices.push_back(idx++);
		}
	}
