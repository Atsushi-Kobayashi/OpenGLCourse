...
// シェーダファイル
static const std::string VERT_SHADER_FILE = std::string(SHADER_DIRECTORY) + "phong.vert";
static const std::string FRAG_SHADER_FILE = std::string(SHADER_DIRECTORY) + "phong.frag";
