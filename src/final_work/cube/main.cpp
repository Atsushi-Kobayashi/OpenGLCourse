...
// 物体の速度を格納
glm::vec3 ball_v = glm::vec3(0.01f, 0.01f, 0.0f);
...
void paintGL()
{
    ...
    glm::mat4 mvpMat = projMat * viewMat * modelMat * transMat;
...
void animate()
{
    ...
    // 平行移動行列を更新
    transMat = glm::translate(transMat, ball_v);
    ball_v += glm::vec3(0.0f, -0.0001f, 0.0f);
}
